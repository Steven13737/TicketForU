...
public class TicketMasterAPI {
	...
	private static final String API_KEY = "vL7wEUtqq6hdcuimaJxlyKqtlLcQwmwW";
	...
	public List<Item> search(double lat, double lon, String keyword) {
		...
		// "apikey=vL7wEUtqq6hdcuimaJxlyKqtlLcQwmwW&latlong=37,-120&keyword=event&radius=50"
